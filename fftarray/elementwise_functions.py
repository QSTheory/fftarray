...
from .fft_array import elementwise_one_operand, elementwise_two_operands, FFTArray, add_transforms_lut, mul_transforms_lut
...
divide = elementwise_two_operands("divide", mul_transforms_lut)
