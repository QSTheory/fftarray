...
class FFTArray(metaclass=ABCMeta):
    ...
    def is_eager(self) -> bool:
        """True if the FFTArray is eager, i.e., is not evaluated lazily.
        Otherwise, False."""
    ...
    def pos_array(self, tlib: Optional[TensorLib] = None) -> PosArray:
        """The position space representation of the wave function.
        Performs the FFT is necessary."""
        ...

    @abstractmethod
    def freq_array(self, tlib: Optional[TensorLib] = None) -> FreqArray:
        """The frequency space representation of the wave function.
        Performs the FFT is necessary."""
        ...
...
class FFTDimension:
    ...
    **Examples**::
    ...
    def pos_array(
        ...
        """PosArray (FFTArray in position space).
    ...
    def freq_array(
        ...
        """FreqArray (FFTArray in frequency space).
