...
class UnpackedValues:
    ...
    factors_applied: List[List[Optional[bool]]]
    ...
    **Examples**::
    ...
    def fft_array(
        ...
        if space == "pos":
            ...
            values = values = indices * dim.d_freq + dim.freq_min
        return FFTArray(
            values=values,
            dims=[dim],
