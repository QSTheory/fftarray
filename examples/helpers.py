...
def plt_fftarray(
    ...
    if len(arr.dims) == 1:
        ...
        p_pos.line(np.array(dim.pos_array()), np.real(arr.into(space="pos").values), line_width=2, color = "navy", legend_label="real")
        p_pos.line(np.array(dim.pos_array()), np.imag(arr.into(space="pos").values), line_width=2, color = "firebrick", legend_label="imag")
        ...
        p_freq.line(np.array(dim.freq_array()), np.real(arr.into(space="freq").values), line_width=2, color = "navy", legend_label="real")
        p_freq.line(np.array(dim.freq_array()), np.imag(arr.into(space="freq").values), line_width=2, color = "firebrick", legend_label="imag")
